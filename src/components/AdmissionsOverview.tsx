...
import { Award, GraduationCap, Compass, MapPin, Mail, Sparkles } from 'lucide-react';
...
export const AdmissionsOverview: React.FC = () => {
  ...
  return (
    <section data-slot="admissions-overview" id="overview" className="py-12 bg-academic-100/60 dark:bg-academic-900/40 border-b border-academic-200 dark:border-academic-800">
