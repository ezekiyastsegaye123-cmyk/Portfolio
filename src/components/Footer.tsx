...
export const Footer: React.FC = () => {
  ...
  return (
    <footer data-slot="footer" className="no-print py-12 border-t border-academic-200 dark:border-academic-800 bg-white dark:bg-academic-950 text-xs text-academic-500">
